    ...
    <div id="md_en" data-target="out_en" className="agreement_md">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Surfing Dirt.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Surfing Dirt, accessible from{' '}
            <a href="https://www.surfingdirt.com" rel="external nofollow noopener" target="_blank">
              https://www.surfingdirt.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://www.surfingdirt.com/privacy"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://www.surfingdirt.com/privacy
          </a>
        </li>
      </ul>
    </div>
...
export default Translate(messages)(Privacy);
