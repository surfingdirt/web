const routes = {
  ...
  ALBUM_NEW: '/new-album',
  ALBUMS: '/albums',
  ARTICLE_MBS_MATRIX_2_MODS: '/article/mbs-matrix-2-mods',
  ...
  FEED: '/feed',
  FOUR_DOWN: '/the-4-down-project',
  FOUR_DOWN_LOGIN: '/the-4-down-project/:id/login',
  FOUR_DOWN_VIDEO: '/the-4-down-project/:id',
